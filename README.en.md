...
| 3. Synthesis & Validation | `master_judge` | Custom heuristics | Merges tables into the narrative skeleton, applies PT-BR morphological filters, and injects YAML metadata (frontmatter). |
